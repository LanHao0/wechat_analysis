...
if __name__ == "__main__":
    ...
    xls = pd.read_excel(r'D:\Wechat_chatRecord_dataMing\wzyandme.xlsx', header=0)
    ...
    another_people="王"
    G.add_node(another_people)
    node_list.append(another_people)
